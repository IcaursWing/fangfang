...
import myutil.MusicUtil.MusicSendObject;
import myutil.MusicUtil.Yin;
...
public class OidBoxGameMusic extends Activity implements CustomAdapt {
    ...
    TextView tv_yin;
    SuperButton bt_create, bt_midi, bt_mp3, bt_stop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("音乐创作");
        Init();
        StatusBarUtils.fullScreen(OidBoxGameMusic.this);
