                ...
                if (!et_username.getText().toString().equals("") && !et_password.getText().toString().equals("")) {
                    ...
                    Thread thread = new Thread() {
                        ...
                        public void run() {
                            ...
                            StringRequest request = new StringRequest("http://36.155.102.74:8888/OidBox/applogin", RequestMethod.POST);
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (state.equals("0")) {
                                            ...
                                            editor.putString("username", response.get());
                                            editor.putString("password", info.getValue("password", 0));
                                            editor.putString("phone", info.getValue("phone", 0));
                                            editor.putString("fangmac", info.getValue("fangmac", 0));
                                            editor.putString("fangid", info.getValue("fangid", 0));
                                            editor.apply();

                                            confirmDialog.setMsg("登录成功").setLogoImg(R.drawable.ic_dialog_finish);
