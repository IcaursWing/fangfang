...
public class RoboSoulListAdapter extends Activity {
    ...
    public RoboSoulListAdapter(BluetoothAdapter adapter, Context context1) {
    ...
    class DeviceListAdapter1 extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position <= dev_ble.size()) {
                ...
                if (type_0 == JDY_type.JDY && dev_ble.get(position).getName().contains("Robo"))// 为标准透传模块
                {
                    // Log.d( "JDY_type.JDY=","1000");
                    // if (convertView == null)
                    {
                        convertView = LayoutInflater.from(context).inflate(R.layout.listitem_device, null);
                        convertView.setBackgroundResource(R.drawable.roboitem);
                        convertView.setAlpha(Float.valueOf((float) 0.7));
                    ...
                    if (viewHolder.tv_devName != null) {
                        ...
                        viewHolder.tv_devName.setTextColor(Color.parseColor("#FFFFFF"));
                    }
                    ...
                    if (viewHolder.tv_devAddress != null) {
                        ...
                        viewHolder.tv_devAddress.setTextColor(Color.parseColor("#FFFFFF"));
                    }

                    String rssi_00 = "" + dev_rssi.get(position);
                    rssi_00 = "信号强度:" + rssi_00 + "dBm";
                    if (viewHolder.device_rssi != null) {
                        viewHolder.device_rssi.setText(rssi_00);
                        viewHolder.device_rssi.setTextColor(Color.parseColor("#FFFFFF"));
                    }
                    ...
                    if (viewHolder.type0 != null) {
                        ...
                        viewHolder.type0.setVisibility(View.GONE);
                    }
