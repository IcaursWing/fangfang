...
public class MutiFangfang extends Activity {
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_muticontrol:
                Intent intent = new Intent(MutiFangfang.this, MutiFangfangControl.class);
    ...
    private void setScanRule() {
        BleScanRuleConfig scanRuleConfig = new BleScanRuleConfig.Builder().setServiceUuids(null)      // 只扫描指定的服务的设备，可选
                .setDeviceName(true, "FF")   // 只扫描指定广播名的设备，可选
    ...
    private void connect(final BleDevice bleDevice) {
        BleManager.getInstance().connect(bleDevice, new BleGattCallback() {
            ...
            public void onConnectFail(BleDevice bleDevice, BleException exception) {
                ...
                Toast.makeText(MutiFangfang.this, getString(R.string.connect_fail), Toast.LENGTH_LONG).show();
            }
            ...
            public void onDisConnected(boolean isActiveDisConnected, BleDevice bleDevice, BluetoothGatt gatt, int status) {
                ...
                if (isActiveDisConnected) {
                    Toast.makeText(MutiFangfang.this, getString(R.string.disconnected), Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(MutiFangfang.this, "连接被断开", Toast.LENGTH_LONG).show();
