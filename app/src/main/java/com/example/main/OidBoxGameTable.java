...
import com.example.myutil.DataTypeConversion;
import com.example.myutil.RandomSort;
import com.example.myutil.UnsignedUtil;
...
public class OidBoxGameTable extends Activity implements CustomAdapt {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bt_Rank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SortL2H(RankListID, RankList, RankListTime);
                ...
                for (int i = -0; i < RankList.size(); i++) {
                    stringBuilder.append("第" + (i + 1) + "名：" + RankListID.get(i) + "号" + RankList.get(i) + "秒 ---" + RankListTime.get(i) + "\n");
                }
                tv_Rank.setText(stringBuilder.toString());
...
//                                        Fang3Transfer = true;
        ...
        for (int i = 0; i < bleDevices.size(); i++) {
            ...
            if (bleDevices.get(i).getName().contains("01")) {
